...
Отримати інформацію про questions.title
  ...
  ${return_value}=   Get text       xpath=//span[@class="item-questions.title questionTitle-${arguments}"]/div[1]/div/h4/span
  [return]  ${return_value}
...
Отримати інформацію про questions[3].answer
  Click Element      xpath=//a[@class="auctionQuestionList"]
  ${return_value}=   Отримати текст із поля і показати на сторінці   questions[3].answer
  [return]  ${return_value}
